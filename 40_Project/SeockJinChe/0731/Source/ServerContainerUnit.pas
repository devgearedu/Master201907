...
uses System.SysUtils, System.Classes,
  ...
  IPPeerServer, IPPeerAPI, Datasnap.DSAuth, Web.HTTPApp,
  Datasnap.DSClientMetadata, Datasnap.DSServerMetadata,
  Datasnap.DSProxyDispatcher, Datasnap.DSProxyJavaScript, Datasnap.DSMetadata;
...
procedure TServerContainer1.WebFileDispatcher1BeforeDispatch(Sender: TObject;
  const AFileName: string; Request: TWebRequest; Response: TWebResponse;
  var Handled: Boolean);
var
  D1, D2: TDateTime;
