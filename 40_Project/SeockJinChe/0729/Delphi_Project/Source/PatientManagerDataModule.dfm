object frmDataModule: TfrmDataModule
  ...
  object Diagnosis: TClientDataSet
    ...
    object DiagnosisDIAGNOSIS_LOG: TWideStringField
      DisplayLabel = #51652#52272#45236#50669
  ...
  object Accept: TClientDataSet
    ...
    object AcceptRESERVE_SEQ: TIntegerField
      DisplayLabel = #51652#47308#48264#54840
      FieldName = 'RESERVE_SEQ'
    end
    object AcceptACCEPT_NAME: TStringField
      DisplayLabel = #54872#51088#47749
      FieldKind = fkLookup
      FieldName = 'ACCEPT_NAME'
      LookupDataSet = Reserve
      LookupKeyFields = 'RESERVE_SEQ'
      LookupResultField = 'PATIENT_NAME'
      KeyFields = 'RESERVE_SEQ'
    ...
    object AcceptPRICE: TIntegerField
