object ServerMethods: TServerMethods
  ...
  object qryReserve: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM RESERVATION ORDER BY RESERVATION_DATE, RESERVATION' +
        '_TIME ')
    Left = 56
    Top = 136
  ...
  object qryDiagnosis: TFDQuery
    ...
    object qryDiagnosisDIAGNOSIS_LOG: TWideStringField
      FieldName = 'DIAGNOSIS_LOG'
      Origin = 'DIAGNOSIS_LOG'
      Size = 4000
    end
  end
  ...
  object qryDecision: TFDQuery
    ...
    Connection = PMConnection
    SQL.Strings = (
      'SELECT RESERVE_SEQ, MEDICINE_SEQ, ACCEPT_AMOUNT, PRICE '
      'FROM DECISION '
  ...
  object qryAccept: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT NOWSTATE, RESERVE_SEQ, REASON, PRICE FROM RESERVATION, DE' +
        'CISION WHERE NOWSTATE = 30')
    Left = 288
    Top = 304
    ...
    object qryAcceptRESERVE_SEQ: TIntegerField
      FieldName = 'RESERVE_SEQ'
      Origin = 'RESERVE_SEQ'
    end
    ...
    object qryAcceptPRICE: TIntegerField
      FieldName = 'PRICE'
      Origin = 'PRICE'
    end
  end
