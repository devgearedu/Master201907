object ServerMethods: TServerMethods
  ...
  object qryPatientList: TFDQuery
    ...
    object qryPatientListUSER_ID: TWideStringField
      FieldName = 'USER_ID'
      Origin = 'USER_ID'
      Size = 200
    end
    object qryPatientListUSER_PASSWORD: TWideStringField
  ...
  object qryMobileUser: TFDQuery
    Connection = PMConnection
    SQL.Strings = (
      'SELECT * FROM PATIENT_LIST WHERE PATIENT_SEQ = 1')
    Left = 56
    Top = 360
    object qryMobileUserPATIENT_SEQ: TIntegerField
      FieldName = 'PATIENT_SEQ'
      Origin = 'PATIENT_SEQ'
    end
    object qryMobileUserPATIENT_NAME: TWideStringField
      FieldName = 'PATIENT_NAME'
      Origin = 'PATIENT_NAME'
      Size = 200
    end
    object qryMobileUserPATIENT_BIRTH: TDateField
      FieldName = 'PATIENT_BIRTH'
      Origin = 'PATIENT_BIRTH'
    end
    object qryMobileUserPATIENT_IMAGE: TBlobField
      FieldName = 'PATIENT_IMAGE'
      Origin = 'PATIENT_IMAGE'
    end
    object qryMobileUserPATIENT_PHONE: TWideStringField
      FieldName = 'PATIENT_PHONE'
      Origin = 'PATIENT_PHONE'
      Size = 44
    end
    object qryMobileUserPATIENT_GENDER: TWideStringField
      FieldName = 'PATIENT_GENDER'
      Origin = 'PATIENT_GENDER'
      FixedChar = True
      Size = 4
    end
    object qryMobileUserUSER_ID: TWideStringField
      FieldName = 'USER_ID'
      Origin = 'USER_ID'
      Size = 200
    end
    object qryMobileUserUSER_PASSWORD: TWideStringField
      FieldName = 'USER_PASSWORD'
      Origin = 'USER_PASSWORD'
      Size = 200
    end
  end
  object MobileUserProvider: TDataSetProvider
    DataSet = qryMobileUser
    Left = 168
    Top = 360
  end
  object qryMobileReserve: TFDQuery
    Connection = PMConnection
    SQL.Strings = (
      
        'SELECT * FROM RESERVATION WHERE PATIENT_SEQ = 1 AND NOWSTATE = 1' +
        '0')
    Left = 288
    Top = 360
    object qryMobileReserveRESERVE_SEQ: TIntegerField
      FieldName = 'RESERVE_SEQ'
      Origin = 'RESERVE_SEQ'
    end
    object qryMobileReservePATIENT_SEQ: TIntegerField
      FieldName = 'PATIENT_SEQ'
      Origin = 'PATIENT_SEQ'
    end
    object qryMobileReserveDOCTOR_SEQ: TIntegerField
      FieldName = 'DOCTOR_SEQ'
      Origin = 'DOCTOR_SEQ'
    end
    object qryMobileReserveNOWSTATE: TIntegerField
      FieldName = 'NOWSTATE'
      Origin = 'NOWSTATE'
    end
    object qryMobileReserveRESERVATION_DATE: TDateField
      FieldName = 'RESERVATION_DATE'
      Origin = 'RESERVATION_DATE'
    end
    object qryMobileReserveRESERVATION_TIME: TTimeField
      FieldName = 'RESERVATION_TIME'
      Origin = 'RESERVATION_TIME'
    end
    object qryMobileReserveREASON: TWideStringField
      FieldName = 'REASON'
      Origin = 'REASON'
      Size = 4000
    end
    object qryMobileReserveTOTAL_PRICE: TIntegerField
      FieldName = 'TOTAL_PRICE'
      Origin = 'TOTAL_PRICE'
    end
  end
  object MobileReserveProvider: TDataSetProvider
    DataSet = qryMobileReserve
    Left = 384
    Top = 360
  end
end
