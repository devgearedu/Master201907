...
type
  TfrmDataModule = class(TDataModule)
    ...
    DecisionPATIENT_SEQ: TIntegerField;
    AcceptPATIENT_SEQ: TIntegerField;
    AcceptPATIENT_NAME: TStringField;
    DecisionDIAGNOSIS_DATE: TDateField;
    AcceptTOTAL_PRICE: TIntegerField;
    DiagnosisRESERVE_SEQ: TIntegerField;
    DiagnosisPATIENT_SEQ: TIntegerField;
    DiagnosisDOCTOR_SEQ: TIntegerField;
    DiagnosisNOWSTATE: TIntegerField;
    DiagnosisRESERVATION_DATE: TDateField;
    DiagnosisRESERVATION_TIME: TTimeField;
    DiagnosisREASON: TWideStringField;
    DiagnosisTOTAL_PRICE: TIntegerField;
    DiagnosisDOCTOR_NAME: TStringField;
