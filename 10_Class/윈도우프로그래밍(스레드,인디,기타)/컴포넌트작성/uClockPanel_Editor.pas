...
procedure Register;
begin
  RegisterComponents('Samples', [TTClockPanel]);
  RegisterComponentEditor(TClockPanel,TClockPanelEditor);
  RegisterPropertyEditor(typeinfo(String),TClockPanel,'DispalyFormat',TFormatProperty);
end;
