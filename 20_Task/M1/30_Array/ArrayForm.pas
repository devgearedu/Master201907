...
type
  ...
  private
    FNumArr: array[0..9] of Integer;                                   //1차원 배열 10칸
...
begin
  ...
  for I := 0 to Length(FNumArr) - 1 do                                   //(1)배열값 출력
...
begin
  ...
  for I := 0 to Length(FNumArr) - 1 do                                   //(2)배열값 더하기
    Sum := Sum + FNumArr[I];
...
begin
  ...
  for I := 0 to Length(FNumArr) - 1 do                                   //(3)큰값 반환
    begin
...
begin
  ...
  for I := 0 to Length(FNumArr) - 1 do                                   //(4)50이상 확인
    begin
