...
function TForm2.GetUserInfoMsg(AName: string; AAge: Integer;              //(2)성별 확인
...
{ TODO :
  ...
  if AAge >= 20 then                                                     //(1)성인여부 확인
    Adult := '성인'
  else
    Adult := '미성년';

  Msg := Msg + AName + '님은 ' + IntToStr(AAge) + '세로 ' + Adult +
    '입니다.';
